...
var _TabbedInputs = _interopRequireDefault(require("./TabbedInputs"));

var _Inputs = _interopRequireDefault(require("./Inputs"));

var _CustomLayout = _interopRequireDefault(require("./CustomLayout"));

var _FormTab = _interopRequireDefault(require("./FormTab"));
...
function (_Component) {
  ...
  _createClass(Content, [{
    ...
    value: function getComponent() {
      ...
      if (firstElement.type === _FormTab.default) {
        return _TabbedInputs.default;
      }
    ...
    value: function render() {
      ...
      return _react.default.createElement(this.getComponent(), {
        basePath: basePath,
        record: record,
        resource: resource,
        position: position
