...
ResetPasswordForm.propTypes = _objectSpread({}, _reduxForm.formPropTypes, {
  classes: _propTypes.default.objectOf(_propTypes.default.string),
  resetPassword: _propTypes.default.func.isRequired,
...
var _default = (0, _redux.compose)(_reactAdmin.translate, (0, _styles.withStyles)(_styles2.default), (0, _reactRedux.connect)(mapStateToProps, null), (0, _reduxForm.reduxForm)({
  form: 'RESET_PASSWORD'
}))(ResetPasswordForm);
